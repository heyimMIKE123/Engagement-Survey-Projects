...
The origins of employee [aka work; e.g., @schaufeli_conceptualization_2010] engagement research began with theoretical expansions of forms of employee participation [see, for example, @ferris_added_1984] and job involvement [e.g., @elloy_examination_1991]. Overtime research and theory expanded into broader considerations of attitudes and emotions [@staw_employee_1994] and were further supplemented by the dimensionality of constructs such as organizational commitment [@meyer_three-component_1991]. The 1990's saw focused development and refinement [for example, a dissertation; @leone_relation_1995 or actual semantic reference; @kahn1990psychological]. 

This development inevitably resulted in multiple differing perspectives of engagement. Some viewed engagement from an attitudinal perspective [@staw_employee_1994; @kahn1990psychological], while others viewed it from a substative perspective [@schaufeli_measurement_2002]. @schaufeli2013engagement distinguished between various forms of engagement (work engagement and employee engagement). @maslach_early_2008 proposed that engagement and burnout [a psychological syndrome consisting of exhaustion, cynicism, and inefficacy; see @leiter_areas_2004; @maslach1997causes] are direct opposites of each other, though many consider these constructs to be conceptually distinct (@timms2012burnt; @kim_burnout_2009; @goering2017not; @schaufeli2008workaholism; @trogolo2020work). The present article explores two methods for constructing a scale that incorporates both the substantive and attitudinal models into one, a more classical one based on corrected item-total correlations and one based on modification indices.
