...
main_textsize: 
main_findings: 
  - '![](bigpic3.svg){.main_pic2}' # main_pic is used to center align 
  - '![](harver.png){.main_pic3}' # main_pic is used to center align 
...
logoright_name: '![](erg3.svg){.new-img-right}'
main_width: 0.35	
csl: "apa7.csl"
body_textsize: "48px"
poster_height: "36in"
...
.new-img-right {
  ...
  top: 5px;
  left: 50px;
  width: 600px;           /* Play with width and height specifications if image stretches*/
  height: 600px;
}
